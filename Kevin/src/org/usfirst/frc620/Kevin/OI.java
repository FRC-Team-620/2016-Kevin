...
public class OI {
    ...
    public OI() {
        ...
        joystickButton2 = new JoystickButton(joystickRight, 1);
        joystickButton2.whileHeld(new DriveWithJoystick());
        joystickLeft = new Joystick(0);
        
        joystickButton1 = new JoystickButton(joystickLeft, 1);
        ...
        SmartDashboard.putData("Lift: retracted", new Lift(false));
